...
// vim: ft=groovy
            environment {
                AN_ACCESS_KEY = credentials('jenkins_to_ubuntu_dick')
            }

node {
   stage('Preparation') { // for display purposes
//   sh "rm -rf .git"
    git branch: 'regression', changelog: false, credentialsId: 'jenkins_to_gitHUB', poll: false, url: 'https://github.com/yeahydq/compareXML.git'
